...
class GeneticAlgorithm:
    def __init__(self, pop_size, mutation_rate, tournament_size, improvement_threshold, max_stagnant_generations):
...
#list of city names kudos Susanne
city_names = [
...
ga = GeneticAlgorithm(pop_size=100, mutation_rate=0.01, tournament_size=20, improvement_threshold=0.01, max_stagnant_generations=100)
